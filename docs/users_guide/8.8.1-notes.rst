...
- Export deprecation is now supported. Please refer to `GHC proposal #28 <https://github.com/ghc-proposals/ghc-proposals/blob/master/proposals/0028-deprecating-exports-proposal.rst>`__ and the `updated user guide <https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/glasgow_exts.html#warning-and-deprecated-pragmas>`__
